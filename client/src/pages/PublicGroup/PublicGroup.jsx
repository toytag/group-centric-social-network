...
export default function PublicGroup() {
  ...
  function actionBar(groupToDisplay) {
    return (
      <Paper className={classes.actionSectionBG}>
        <div className={classes.actionSection}>
          ...
          {groupToDisplay && groupToDisplay.admins.indexOf(userID) >= 0 && <IconButton size="medium" sx={{ marginLeft: '25px' }} onClick={handleClickAdmin}><AssignmentInd /></IconButton>}
          {groupToDisplay && groupToDisplay.creator !== userID && <IconButton size="medium" sx={{ marginLeft: '25px' }} onClick={() => setExitModal(true)}><ExitToApp /></IconButton>}
